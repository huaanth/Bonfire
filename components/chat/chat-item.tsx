...
const roleIconMap={
    "GUEST":null,
    "MODERATOR": <ShieldCheck className="h-4 w-4 ml-2 text-yellow-300"/>,
...
export const ChatItem =({
    ...
    return (
        ...
        p-4 transition w-full">
            <div className="group flex gap-x-2 items-start w-full">
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isPDF && (
                        ...
                        bg-background/10">
                            <FileIcon className="h-10 w-10 fill-yellow-200
                             stroke-yellow-400"/>
                             <a 
                             href={fileUrl}
                             target="_blank"
                             rel="noopener noreferrer"
                             className="ml-2 text-sm text-yellow-500 dark:text-yellow-400
                             hover:underline">
                                PDF File
            ...
            {canDeleteMessage &&(
                <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-800 border
                rounded-sm">
                    {canEditMessage && (
