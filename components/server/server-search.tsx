    ...
    return(
        ...
        className="group px-2 py-2 rounded-md flex
         ...
         dark:hover:bg-yellow-700/50 transition">
            ...
            dark:text-zinc-300 group-hover:text-zinc-600
            dark:group-hover:text-zinc-100 transition">
                Search
            </p>
            <kbd className="pointer-events-none inline-flex h-5 select-none
             items-center gap-1 rounded border bg-muted px-1 font-mono text-[10px]
             font-medium text-muted-foreground ml-auto">
                <span className="text-xs">⌘</span>K
            </kbd>
        </button>
        <CommandDialog open = {open} onOpenChange={setOpen}>
            <CommandInput placeholder="Search all tents and campers"/>
            <CommandList>
                <CommandEmpty>
                    No Results found
                </CommandEmpty>
